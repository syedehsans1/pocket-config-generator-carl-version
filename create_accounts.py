...
def generate_pocket_accounts(num_accounts, customer_prefix):
    ...
    with open(output_path, mode="w", newline="") as csvfile:
        writer = csv.DictWriter(csvfile, fieldnames=["customer_id", "operator_address", "mnemonic", "owner_address", "revshare_address", "publicly_exposed_url", "rpc_type", "owner_private_key"])
        writer.writeheader()
